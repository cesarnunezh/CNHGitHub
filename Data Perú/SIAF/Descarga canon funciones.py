...
for k in range(2021, 2022):
    ...
    canon_minero = b.find_element_by_xpath("/html/body/form/div[4]/div[3]/div[3]/div/table[2]/tbody/tr[8]")
    canon_minero.click()
    time.sleep(1.5)
    ...
    for l in range(2, count):
        ...
        dpto = b.find_elements_by_xpath("/html/body/form/div[4]/div[3]/div[3]/div/table[2]/tbody/tr")
        ...
        for l in range(1, count):
            ...
            volver_dpto = b.find_element_by_xpath("/html/body/form/div[4]/div[3]/div[2]/table/tbody/tr[5]/td[1]")
            volver_dpto.click()
        
        
        volver_nivel_gob = b.find_element_by_xpath("/html/body/form/div[4]/div[3]/div[2]/table/tbody/tr[4]/td[1]")
