/*==============================================================================
 Nombre del código:			Gasto de bolsillo 2013-2021
 Autor:		 				César Núñez
 Objetivo:					Estimar el gasto de bolsillo para el 2013 en adelante
 Bases a usar:				Encuesta Nacional de Hogares (ENAHO) - 2013-2021
...
*	2. Limpieza de base
{
	...
	*Variables relevantes
	global varlist "aÑo mes conglome vivienda hogar codperso ubigeo dominio estrato p401 p4021 p4022 p4023 p4024 p4025 p4031 p4032 p4033 p4034 p4035 p4036 p4037 p4038 p4039 p40310 p40311 p40313 p40314 p4091 p4092 p4093 p4094 p4095 p4096 p4097 p4098 p4099 p40910 p40911 p4151_* p4152_* p4153_* p4154_* p417_02 p417_08 p417_11 p417_12 p417_13 p417_14 p419* i41601 i41602 i41603 i41604 i41605 i41606 i41607 i41608 i41609 i41610 i41611 i41612 i41613 i41614 i41615	i41616 factor07"

	*Trabajando con las bases 
	use $varlist using "$bd/enaho01a-2007-400_2013.dta", clear
	forv x=2014/2021 {

	append using "$bd/enaho01a-2007-400_`x'.dta" , keepusing($varlist)

	}

	save "$temp/enaho_salud.dta", replace
