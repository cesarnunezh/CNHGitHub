/*==============================================================================
 Nombre del código:			Cálculo del gasto en alimentos según situación de pobreza urbana
 Autor:		 				César Núñez
 Objetivo:					Limpiar la ENAHO y estimar variables
 Bases a usar:				Encuesta Nacional de Hogares (ENAHO) - 2018
...
*	2. Limpieza de base
{
	...
	merge 1:m conglome vivienda hogar using "$bd\enaho01a-2018-500.dta", gen (m)
	keep if m==3
	drop m
