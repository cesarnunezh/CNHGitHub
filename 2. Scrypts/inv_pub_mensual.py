# -*- coding: utf-8 -*-
"""
Created on Thu Oct 14 12:47:58 2021
...
for k in range(2010, 2022):
    print(str(k))
    b.get("https://apps5.mineco.gob.pe/transparencia/mensual/default.aspx?y=" + str(k) + "&ap=Proyecto")
    ...
    for l in range(1, count):
        ...
        for l in range(1, count2):
            ...
            volver_dpto = b.find_element_by_xpath("/html/body/form/div[4]/div[3]/div[2]/table/tbody/tr[3]/td[1]")
            volver_dpto.click()
